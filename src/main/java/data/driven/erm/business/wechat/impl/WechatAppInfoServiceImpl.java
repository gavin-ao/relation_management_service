...
public class WechatAppInfoServiceImpl implements WechatAppInfoService {
    ...
    public WechatAppInfoEntity getAppInfo(String appid) {
        String sql = "select app_info_id,app_name,appid,secret,create_at,creator,mch_id,security_id from wechat_app_info where appid = ?";
    ...
    public List<WechatAppInfoEntity> findAppInfoListByUser(String userInfoId) {
        String sql = "select wai.app_info_id,wai.app_name,wai.appid,wai.secret,wai.create_at,wai.creator,wai.mch_id,wai.security_id from wechat_app_info wai" +
