...
import static data.driven.erm.common.Constant.USER_INFO_MAX_INTERVAL;
...
public class WechatLoginApiController {
    ...
    public JSONObject newLogin(String appid, String secret, String code, String encryptedData, String iv){
        ...
        if(sessionJsonObject.containsKey("session_key")){
            ...
            return putMsg(false, "101", "获取不到session_key，请重新登录");
        }
        //设置缓存
    ...
    private JSONObject syncUser(String encryptedData, String iv, String sessionID, WechatApiSessionBean wechatApiSessionBean) {
        ...
        try{
            ...
            if(interval < 0 || interval > USER_INFO_MAX_INTERVAL){
                return putMsg(false, "102", "处理超时，请重新登录");
            }
...
//            }
        ...
        JSONObject result = putMsg(true, "200", "登录成功");
        return result;
    }
     ...
     */
    @ResponseBody
    @RequestMapping(path = "/syncInvitation")
    public JSONObject syncInvitation(String sessionID, String invitationId){
        WechatApiSessionBean wechatApiSessionBean = WechatApiSession.getSessionBean(sessionID);
        WechatUserInfoVO userInfoVO = wechatApiSessionBean.getUserInfo();
        Object invitater = invitationInfoService.getUserId(invitationId);
        if(invitater == null){
            return putMsg(false, "103", "邀请人不存在");
        }
        return wechatUserService.updateInviter(userInfoVO.getAppInfoId(), userInfoVO.getWechatUserId(), userInfoVO.getOpenId(), invitater.toString());
    }
...
//     */
//    @ResponseBody
//    @RequestMapping(path = "/syncInvitationTest")
//    public JSONObject syncInvitationTest(String sessionID, String invitationId, String str){
//        WechatUserInfoVO userInfoVO = test(str);
//        Object invitater = invitationInfoService.getUserId(invitationId);
//        if(invitater == null){
//            return putMsg(false, "103", "邀请人不存在");
//        }
...
//    }
//
//    private WechatUserInfoVO test(String str){
//        WechatUserInfoVO userInfoVO = new WechatUserInfoVO();
//        userInfoVO.setAppInfoId("5b3dd7c91d76102dd8a2d0d4");
//        userInfoVO.setWechatUserId(str);
//        userInfoVO.setOpenId(str);
//        return userInfoVO;
//    }
