function Table() {
	...
	TClass.init = function(option) {
		...
		Option[id] = {
			...
			headerBgColor: Tool.getValue(option['headerBgColor'], '#ECEFF1'),
			...
			evenBgColor: Tool.getValue(option['evenBgColor'], '#FFFFFF'),
			oddBgColor: Tool.getValue(option['oddBgColor'], '#F7F8F9'),
